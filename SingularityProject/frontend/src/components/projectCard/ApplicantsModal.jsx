// src/components/projectCard/ApplicantsModal.jsx
        ...
        {apps.map(app => (
          <li key={app.application_id} className="border p-4 rounded-lg">
            <p className="font-medium mb-1">
              ...
              <span className="italic">{app.role_applied_for || 'no role given'}</span>
            </p>
            ...
            <div className="flex items-center gap-4 text-sm">
              ...
              {app.cv && (
                <a href={app.cv} className="ml-auto text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">
                  View CV
                </a>
              )}
            </div>
